...
- Port the GDCubism integration to pinned Redot 26.2 and Cubism Native SDK 5-r.5 inputs.
- Add imported `CubismModelResource` assets, dependency tracking, reimport recovery, and the explicit model-import editor command.
- Add `CubismModel2D` rendering, native motion and expression playback, physics, pose, blink, breath, look, hit areas, and bounded manual updates.
- Add character-controller and lip-sync components, recorded-audio cue coordination, and visual-novel/dialogue examples.
