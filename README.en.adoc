...
ifdef::env-github,env-vscode[]
link:README.md[Cubism for Redot]
endif::env-github,env-vscode[]


NOTE: This is preserved upstream GDCubism documentation. For the Redot 26.2 port, use link:docs/README.md[the current guides].
